# SignalsAlpha Process Flow v0

## Overview

This repository contains the complete data pipeline for SignalsAlpha - an automated stock signal generation system. The pipeline runs on an Oracle Cloud Infrastructure (OCI) Free Tier instance and generates daily trading signals for a universe of US stocks.
